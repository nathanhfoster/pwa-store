...
import { getStylesFromProps, RED, LIGHT_BLUE, BLUE, LIGHT_GREY } from '../../utils';
...
const useStyles = makeStyles({
  labelContainer: ({ labelContainerClassFromProps }) =>
    getStylesFromProps(labelContainerClassFromProps, {
      margin: 'auto'
    }),
  label: ({ labelClassFromProps, errorsExist }) =>
    getStylesFromProps(labelClassFromProps, {
  ...
  uploadIcon: ({ uploadIconClassFromProps, disabled }) =>
    getStylesFromProps(uploadIconClassFromProps, {
      marginRight: '0.25rem',
  ...
  subLabels: ({ subLabelsClassFromProps }) =>
    getStylesFromProps(subLabelsClassFromProps, {
      '& em': {
        display: 'block'
      }
    })
...
const mapStateToProps = ({
  classes: { labelContainer, label, uploadIcon, subLabels },
  customErrorMessage,
  error: { errorMessages },
  disabled
}) => ({
