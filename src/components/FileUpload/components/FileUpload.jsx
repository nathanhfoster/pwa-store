...
const useStyles = makeStyles({
  dropZone: ({ dropDownClassFromProps, inDropZone }) =>
  ...
  inputButton: ({ inputButtonClassFromProps }) =>
  ...
  fileImageContainer: ({ fileImageContainerClassFromProps }) =>
...
const mapStateToProps = ({
  classes: { dropZone, inputButton, fileImageContainer, input },
  showDefaultLabel,
  accept,
  multiple,
  disabled,
